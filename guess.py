...
def intPrompt(prompt):
    """Creo un sistema d'ingresso che accetta solo int.
...
# Serie di hint diverse su cui fare un ciclo dopo i tentativi sbagliati
def hint1(n1):
    """Dato un numero n1, controllo se è maggiore o minore di 50."""
    if n1 >= 50:
...
def hint2(n1):
    """Dato un numero n1, controllo se è divisibile per 4"""
    if n1 % 4 == 0:
...
def hint3(n1):
    """Dato un numero n1, controllo se è divisibile per 5"""
    if n1 % 5 == 0:
